    ...
    <div>
      <div className="bg-white rounded-xl shadow-md relative flex flex-col md:flex-row">
        <Image
          ...
          height={0}
          sizes="100vw"
          className="h-auto rounded-t-xl md:rounded-tr-none md:rounded-l-xl md:w-2/5"
        />
        <div className="p-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            ...
            <Link
              ...
              className="h-[36] bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-center text-sm"
            >
              Details
            </Link>
          </div>
